...
function compactForecastSnapshot(snapshot = {}) {
  return {
    ...
    accountValidityHours: number(snapshot.accountValidityHours),
    reviewIntervalHours: number(snapshot.reviewIntervalHours),
    bufferCapHours: number(snapshot.bufferCapHours),
